...
public class GraphicsTemplate {
    ...
    public static void draw(Graphics g) {
        ...
        g.fillOval(100, 160, 200, 100);

        // Tail (triangle)
        int[] tailX = { 100, 60, 60 };
        int[] tailY = { 210, 170, 250 };
        g.fillPolygon(tailX, tailY, 3);

        // Eye
        g.setColor(Color.BLACK);
        g.fillOval(270, 190, 16, 16);

        // Bubbles
        g.setColor(Color.WHITE);
        g.drawOval(300, 140, 18, 18);
        g.drawOval(320, 110, 13, 13);
        g.drawOval(305, 80, 10, 10);
    }
